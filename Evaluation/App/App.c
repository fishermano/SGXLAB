...
int SGX_CDECL main(int argc, char *argv[]){
  ...
  #define BASELINE_RESULT_FILE "./baseline_results/baseline_results_100kbytes.txt"
  #define RESULT_FILE "./results/results_100kbytes.txt"
  #define Encryption_BASELINE_RESULT_FILE "./encryption_baseline_results/baseline_results_10kbytes.txt"
  #define Encryption_RESULT_FILE "./encryption_results/results_10kbytes.txt"
  ...
  for(v = START_FILE_NUM; v <= FILE_NUM; ){
    start = clock();
    ret = ecall_evaluate_encryption(global_eid, &status, v);
    end = clock();
    exe_time = (double)(end - start)/CLOCKS_PER_SEC;
    // printf("\nfile numbers: %d; time: %lf\n", FILE_NUM, exe_time);
    printf("\nwriting to result file: %d\n", v);
    write_result(Encryption_RESULT_FILE, v, exe_time);
    v = v + FILE_NUM_STEP;
  ...
  // for(v = START_FILE_NUM; v <= FILE_NUM; ){
  //   start = clock();
  //   ret = ecall_evaluate_decryption(global_eid, &status, &eval_files[0].payload_tag[0], v, v*(DATA_SIZE + 20));
  //   end = clock();
  //   exe_time = (double)(end - start)/CLOCKS_PER_SEC;
  //   // printf("\nfile numbers: %d; time: %lf\n", FILE_NUM, exe_time);
  //   printf("\nwriting to result file: %d\n", v);
