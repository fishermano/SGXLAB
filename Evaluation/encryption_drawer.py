...
(file_num_1bytes, exe_time_1bytes) = load_data('./encryption_results/results_1byte.txt')
(file_num_1kbytes, exe_time_1kbytes) = load_data('./encryption_results/results_1kbytes.txt')
(file_num_10kbytes, exe_time_10kbytes) = load_data('./encryption_results/results_10kbytes.txt')

(bl_file_num_1bytes, bl_exe_time_1bytes) = load_data('./encryption_baseline_results/baseline_results_1byte.txt')
(bl_file_num_1kbytes, bl_exe_time_1kbytes) = load_data('./encryption_baseline_results/baseline_results_1kbytes.txt')
(bl_file_num_10kbytes, bl_exe_time_10kbytes) = load_data('./encryption_baseline_results/baseline_results_10kbytes.txt')
