...
plt.axis([0, 110, 0, 0.28])

plt.scatter(e_file_num_1bytes, e_exe_time_1bytes, s=50, label='1 B', c='blue', marker='_', alpha=None, edgecolors='white')

plt.scatter(e_bl_file_num_1bytes, e_bl_exe_time_1bytes, s=50, label='1 B (baseline)', c='red', marker='_', alpha=None, edgecolors='white')
...
plt.scatter(e_file_num_1kbytes, e_exe_time_1kbytes, s=50, label='1 KB', c='blue', marker='+', alpha=None, edgecolors='white')

plt.scatter(e_bl_file_num_1kbytes, e_bl_exe_time_1kbytes, s=50, label='1 KB (baseline)', c='red', marker='+', alpha=None, edgecolors='white')

plt.scatter(e_file_num_10kbytes, e_exe_time_10kbytes, s=50, label='10 KB', c='blue', marker='^', alpha=None, edgecolors='white')

plt.scatter(e_bl_file_num_10kbytes, e_bl_exe_time_10kbytes, s=50, label='10 KB (baseline)', c='red', marker='^', alpha=None, edgecolors='white')
