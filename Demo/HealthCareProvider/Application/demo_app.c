...
int SGX_CDECL main(int argc, char *argv[]){
  ...
  */
  ...
  #define ENC_RESULT_FILE "./sgx_enc_results_10KB.txt"
  #define DEC_RESULT_FILE "./sgx_dec_results_10KB.txt"
  ...
  */
  ...
  //
  //   if((SGX_SUCCESS != ret) || (SGX_SUCCESS != status)){
  //     fprintf(OUTPUT, "\nError, evaluation encryption using shared key based AESGCM failed in [%s]. ret = 0x%0x. status = 0x%0x", __FUNCTION__, ret, status);
  //   }
  // }
